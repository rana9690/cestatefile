                ...
                <div class="content clearfix">
                        ...
                        <div class="row">
                            <div class="offset-md-8 col-md-4">
                                <input  type="button" value="Save and Next" id="chkBtn"  class="btn btn-success" onclick="iachecksubmit();"  disabled="disabled">
...
<script>
    ...
    function iachecksubmit(){
        ...
        if(allCheck=='9'){
            $.ajax({
                type: 'post',
                url: base_url+'chk_listdataCave',
                data: $('form').serialize(),
                dataType: 'json',
                success: function(rtn){
                    if(rtn.error=='0'){
                         setTimeout(function(){
                            window.location.href = base_url+'cav_finalprivew';
                         }, 250); 
                    }
                    else if(rtn.error=='1'){
                        $.alert(rtn.error);
