          ...
          <div style="margin-top:50px">
    		...
    		<div class="row">
                <div class="offset-md-8 col-md-4" style="margin-left: 900px;">
                    <input type="button" value="Save and Next" class="btn btn-success" onclick="certSubmitBasic();">
	...
	$.ajax({
        ...
        success: function (resp) {
        	...
        	if(resp.data=='success') {
		       setTimeout(function(){
                    window.location.href = base_url+'certpartydetail';
               }, 250);
			}
...
function  diary(){
   with(document.rpepcpbascidetail){
	action = base_url+"certbasicdetail";
	submit();
