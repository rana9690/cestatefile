...
<div id="rightbar">
    ...
    <form action="#" id="frmCounsel" autocomplete="off">
        ...
        <div class="content" style="padding:0px;">
            <div class="row">
                <div class="card checklistSec" style="">
                    <fieldset id="condetail" style="margin-top:20px;">
                        ...
                        <legend class="customlavelsub">Counsel/ Representative Details<div class="date-div text-success date"><?=$this->lang->line('referenceno').' :'.$salt?></div></legend>
                        <div class="row">
                            <?php 
                    ...
                    ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group required" id="div-add">
                                    ...
                                    <input type="text" name="advname" value="" id=advname class="form-control"
                                        onkeypress="serchrecordvaladv(this.value);">
                            ...
                            <div class="col-md-4">
                                <div class="form-group required">
                                    ...
                                    <?php
                                    $pet_council_adv=($pet_council_adv>0)?$pet_council_adv:0;
                                    $c_pet_district= getAdvocates($schemas,['adv_code'=>$pet_council_adv]);// $this->efiling_model->data_list('master_advocate','adv_code',$pet_council_adv);
                                    $cdisrName= isset($c_pet_district[0]['adv_dist'])?$c_pet_district[0]['adv_dist']:0;
                                    $cpetdis=  $this->efiling_model->data_list_where('master_psdist','district_code',$cdisrName); 
                                    ?>
                                    <input type="hidden" name="cddistrict" readonly="" id="cddistrict" class="txt"
                                        maxlength="50"
                                        value="<?php //echo ($c_pet_district[0]['adv_dist'])?$c_pet_district[0]['adv_dist']:0; ?>">
                                    <?= form_input(['name'=>'ddistrictname','value'=>isset($cpetdis[0]->district_name)?$cpetdis[0]->district_name:'','class'=>'form-control','id'=>'ddistrictname','placeholder'=>'ddistrictname','maxlength'=>'100', 'readonly' => 'readonly','title'=>'District Name should be Alfa numeric only.']) ?>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group required">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group required">
                                    ...
                                    <?php   
                                $c_pet_state= getAdvocates($schemas,['adv_code'=>$pet_council_adv]); //$this->efiling_model->data_list('master_advocate','adv_code',$pet_council_adv);
                                $statecode= isset($c_pet_state[0]->state_code)?$c_pet_state[0]['state_code']:0;
                                ...
                                ?>
                                    <input type="hidden" name="cdstate" readonly="" id="cdstate" class="txt"
                                        maxlength="50"
                                        value="<?php echo isset($cstate[0]->state_code)?$cstate[0]->state_code:0;?>">
                                    <?= form_input(['name'=>'dstatename','value'=>isset($cstate[0]->state_name)?$cstate[0]->state_name:'','class'=>'form-control', 'readonly' => 'readonly','id'=>'dstatename', 'placeholder'=>'State name','maxlength'=>'5','title'=>' Counsel District name should be alphanumeric.']) ?>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group required">
                            ...
                            <input type="button" name="" class="btn btn-primary px-4 btn-cntr" onclick="addCouncel()"
                                value="Add">
                        </div>
                    </fieldset>

                    <div class="row m-0">
                        <div class="card w-100 mt-5 pt-3" style="padding: 0px 12px;">
                            <?php  
           $html='';
           $html.='
           ...
           $schemasData=getSchemasNames($vals[0]->bench);
            ...
            $.ajax({
                ...
                success: function(petSection) {
                    ...
                    if (data2.data == 'success') {
                        ...
                        $("#adv_inperson option[value='" + val.adv_name + "']").attr("selected",
                            "selected");
    ...
    $('#frmCounsel').submit(function(e) {
        ...
        var count = document.getElementById("count").value;
        var usertype = '<?=trim($userdata[0]->user_type)?>';
        ...
        var nextUrl = 'petitionDoc';
        <?php if($this->config->item('ia_privilege')==true):?>
        var nextUrl = 'petitionIa';
        <?php endif;?>
        var dataa = {};
        dataa['salt'] = salt,
            dataa['tabno'] = tabno;
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if (resp.data == 'success') {
                    setTimeout(function() {
                        window.location.href = base_url + nextUrl;
    ...
    function editPartyAdv(id, type, advType) {
        ...
        $.ajax({
            ...
            success: function(petSection) {
                ...
                var val = data2.display;
                if (val.salt != '') {
                    //var data2 = data2.display;
                    console.log(data2);
                    if (val.advType == '2') {
                        $("#po1").prop("checked", true);
                        $('#div-add').hide();
                        $('#divin-p').show();
                        $("#adv_inperson option[value='" + val.council_code + "']").attr("selected",
                            "selected");
                    }
                    ...
                    if (val.advType == '1') {
                        ...
                        $("#councilCode option[value='" + val.council_code + "']").attr("selected",
                            "selected");
                    }
    ...
    function serchrecordvaladv(val) {

        $.ajax({
            type: 'post',
            url: base_url + 'getAdvrp',
            data: {
                key: val,
                csrf_token: $("#csrf_token").val(),
                saltNo: $("#saltNo").val()
            },
            //data: {key:val,salt:$("saltNo").val(),csrf_token:$("#csrf_token")},
            dataType: 'html',
            cache: false,
            beforeSend: function() {
                //$('#loading_modal').modal();
