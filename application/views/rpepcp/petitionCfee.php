                            ...
                            <div class="table-responsive">
                                <table datatable="ng" id="examples"
                                    ...
                                    foreach($aDetail as $row) {
                                        ...
                                        <tr>
                                            <td> <?php echo $fgfg; ?></td>
                                            <td><input type="checkbox" name="otherFeeCode" value="<?php echo $row->doc_code; ?>" <?php echo $val;?>
                                        <?php if($this->config->item('ia_privilege')==true): $val='Checked'; ?>disabled<?php endif;?> ></td>
