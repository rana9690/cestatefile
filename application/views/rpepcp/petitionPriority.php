...
<div class="content" style="padding:0px;">
    <div class="row">
        <div class="card checklistSec" style="">
            ...
            <?= form_fieldset('Set Priority For Party <div class="date-div text-success date">'.$this->lang->line('referenceno').' :'.$salt.'</div>'); ?>
                    ...
                    <table id="examples" class="table table-striped table-bordered" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" required="required" name="patyAddIdmain"
                                        value="<?php echo '1'; ?>" <?php echo $checked; ?>></td>
                                <td><input type="text" required="required" size='3' value="<?php echo $sr; ?>"
                                        onkeypress="return /[0-9]/i.test(event.key)" name="numbermian"
                                        onkeyup="valcheck();"></td>
                            </tr>
                            <?php
                                    }
                                ...
                                $sqladd1 = "select * from additional_party_detail where filing_no='$filingno'
and party_flag='P' and party_serial_no in($pid)";
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" required="required" name="patyAddIdmain"
                                        value="<?php echo $id; ?>" <?php echo $checked; ?>></td>
                                <td><input type="text" size='3' required="required" value="<?php echo $srv; ?>"
                                        onkeypress="return /[0-9]/i.test(event.key)" name="numbermian"
                                        onkeyup="valcheck();"></td>
                            </tr>
                            <?php  } ?>
                    ...
                    <table class="table table-bordered" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" required="required" name="patyAddId1"
                                        value="<?php echo '1P'; ?>" <?php echo $checked; ?>></td>
                                <td><input type="text" size='3' required="required" value="<?php echo $srnv; ?>"
                                        name="number1" onkeypress="return /[0-9]/i.test(event.key)"
                                        onkeyup="valcheck1();"></td>
                            </tr>
                            <?php
                                    }
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" required="required" name="patyAddId1"
                                        value="<?php echo '1R'; ?>" <?php echo $checked; ?>></td>
                                <td><input type="text" required="required" size='3' value="<?php echo $srnv; ?>"
                                        onkeypress="return /[0-9]/i.test(event.key)" name="number1"
                                        onkeyup="valcheck1();"></td>
                            </tr>
                            <?php
                                    }
                                    ...
                                    $sqladd1 = "select * from additional_party_detail where filing_no='$filingno' and party_flag='$flag11'";
                                    $query=$this->db->query($sqladd1);
                                    $data = $query->result();
                                    foreach($data as $row){
                                        $checked='';
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-right">
                    <input type="button" value="Save and Next" class="btn btn-success"
                        onclick="rpepcpSubmitPartyPrioirity();">&nbsp;&nbsp;&nbsp;&nbsp;
