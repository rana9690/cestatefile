...
<div class="btn-group btn-breadcrumb breadcrumb-default">
    ...
    <a href="<?php echo base_url(); ?>ia_partydetail" class="<?php echo $iapartytab; ?> visible-lg-block visible-md-block " <?php echo $disabeltab1; ?>>Party Details</a>
    <a href="<?php echo base_url(); ?>ia_detail_ia" class="<?php echo $iadetailtab; ?> visible-lg-block visible-md-block" <?php echo $disabeltab2; ?>>IAs Details</a>
    <a href="<?php echo base_url(); ?>ia_upload_doc" class="<?php echo $iadocumenttab; ?> visible-lg-block visible-md-block "    <?php echo $disabeltab3; ?>>Upload Documents</a>
    <a href="<?php echo base_url(); ?>ia_checklist" class="<?php echo $iachecklisttab; ?> visible-lg-block visible-md-block "  <?php echo $disabeltab4; ?>>Checklist</a>
    <a href="<?php echo base_url(); ?>ia_finalprivew"    class="<?php echo $iafinaptab; ?> visible-lg-block visible-md-block "  <?php echo $disabeltab5; ?>>Final Preview </a>
    <a href="<?php echo base_url(); ?>ia_payment" class="<?php echo $iapaymenttab; ?> visible-lg-block visible-md-block "  <?php echo $disabeltab6; ?>>Payment</a>
    <a href="<?php echo base_url(); ?>ia_finalreceipt" class="<?php echo $iarecepttab; ?> visible-lg-block visible-md-block"  <?php echo $disabeltab7; ?>>Receipt
</a>
