...
$certify_copy_id=$cid;
$filingNo=$filing_no;
    //echo "select cp.id as certify_copy_id,cno.filing_no,cp.certify_number,cno.case_no,cno.dt_of_filing,cno.pet_name,cno.res_name from aptel_case_detail as cno inner join certified_copy as cp on cp.filling_no=cno.filing_no where cp.filing_no={$filingNo} AND cp.certify_number='{$certify_copy_id}'";die;



$query_str="select cp.id as certify_copy_id,cno.filing_no,cp.created_on,cp.certify_number,cno.case_no,cno.dt_of_filing,cno.pet_name,cno.res_name from aptel_case_detail as cno inner join certified_copy as cp on cp.filling_no=cno.filing_no where cp.filling_no='$filingNo' AND cp.certify_number='$certify_copy_id'";
        ...
        <div style="overflow: hidden;">
            <div style="float: left; width: 50%;">
                <span>
                    ...
                    echo "DFR. No.      :-  $val";
                    ?></span>                
                <p> <strong>Appellant/Petitioner Name    :- </strong> <?php echo $row1[0]->pet_name; ?><?php echo $this->efiling_model->fn_addition_party($db,$filingNo,'1'); ?></p>
                <p><strong>Respondent  Name                 :-</strong><?php echo $row1[0]->res_name; ?><?php echo $this->efiling_model->fn_addition_party($db,$filingNo,'2'); ?></p>
            </div>
