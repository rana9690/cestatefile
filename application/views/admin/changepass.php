    ...
    <div class="row">
        ...
        <div class="card checklistSec" style="">
            ...
            <div class="content clearfix" id="document_filing_div_id">
                <?= form_fieldset('Change Password <div class="date-div text-success">Date & Time : &nbsp;<small> '.date('D M d, Y H:i:s') .' &nbsp;IST</small></div>'); ?>

                <div class="container2">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group required">
                                <label for="password"><span class="custom">
                                        <font color="red">*</font>
                                    </span>Old Password </label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group required">
                                <label for="conpass"><span class="custom">
                                        <font color="red">*</font>
                        ...
                        <div class="col-md-12 text-center">
                            <button type="button" name="form_data" id="form_data" class="btn btn-primary"
