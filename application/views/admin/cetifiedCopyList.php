...
<?php
$case_details= $this->db->query("select cp.id as certify_copy_id,cp.certify_number,cno.filing_no,cno.case_no,cno.pet_name from aptel_case_detail as cno inner join certified_copy as cp on cp.filling_no=cno.filing_no");
