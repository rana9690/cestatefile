            ...
            <div class="row">
                <div class="card checklistSec" style="">
                    <fieldset id="condetail" style="margin-top:20px;">
                        ...
                        <legend class="customlavelsub">Counsel/ Representative Details <div class='date-div text-success'><?=$this->lang->line('referenceno').' :'.$salt?></div></legend>
                        <div class="row">
                            <?php 
                                                                    ...
                                                                    $schemasData=getSchemasNames($app[0]->bench);
                            ...
                            <input type="hidden" id="tabno" name="tabno" value="<?php echo '4'; ?>">
                                ...
                                <div class="form-group required">
                                    ...
                                    <?php
                                                                            ...
                                                                            $pet_council_adv=($pet_council_adv>0)?$pet_council_adv:0;
                                                                                $c_pet_district=getAdvocates($schemas,['adv_code'=>$pet_council_adv]);
                                                                                $cdisrName= ($c_pet_district[0]['adv_dist']>0)?$c_pet_district[0]['adv_dist']:0;
                                    ...
                                    <input type="hidden" name="cddistrict" readonly="" id="cddistrict" class="txt"
                                        maxlength="50" value="<?php echo $c_pet_district[0]->adv_dist; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group required">
                                    ...
                                    <?php   
                                                                                    ...
                                                                                    $c_pet_state=  getAdvocates($schemas,['adv_code'=>$pet_council_adv]);
                                    ...
                                    <input type="hidden" name="cdstate" readonly="" id="cdstate" class="txt"
                                        maxlength="50" value="<?php echo $cstate[0]->state_code?>">
                            ...
                            <div class="col-md-4">
                                ...
                                <p style="color:red">"Only Registerd counsel Name can be added" </p>
                            </div>
            ...
            success: function(resp) {
                ...
                if (resp.data == 'success') {
                    setTimeout(function() {
                        ...
                        window.location.href = base_url + 'ia_detail';
                        <?php else:?>
                    ...
                    $('#step_11').removeClass('btn-danger btn-warning btn-info').addClass(
                        'btn-success');
                    $('#step_4').removeClass('btn-danger btn-warning btn-info').addClass(
                        'btn-warning');
