...
$certify_copy_id=base64_decode($cid);
   
$filingNo=base64_decode($filing_no);
    $case_initialization = $this->db->query("select cp.id as certify_copy_id,cp.created_on,cp.party_type,cp.certify_number,cp.party_ids,cp.year,cno.case_type,cno.filing_no,b.short_name,
 cno.case_no,cno.dt_of_filing,cno.pet_name,cno.res_name from 
aptel_case_detail as cno inner join certified_copy as cp on cp.filling_no=cno.filing_no join master_case_type as 
