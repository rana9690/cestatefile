...
<?php } ?>
      ...
      <?= form_fieldset_close(); ?>
          <div style="display:none" id="divstype">
            <?= form_fieldset('Contempt Petition ').'<i class="icon-plus-circle2 text-danger" style="position: absolute;padding: 9px 6px;"></i>'; ?>
                    ...
                    <div class="row alert alert-warning" style="padding: 8px 0px 0px; font-weight: 600;font-size: 18px; margin: -20px auto 12px; max-width: 100%;">
                        ...
                        <div class="col-md-6 md-offset-2">
                            <label for="org" class="form-check-label font-weight-semibold">
                                <?= form_radio(['name'=>'partyType','onclick'=>'load_app_respodent_contempt_petition(1)','checked'=>('1' == $partytype) ? TRUE : FALSE,'value'=>'1','id'=>'pet']); ?>Applicant&nbsp;&nbsp;
                            </label>
                            <label for="indv" class="form-check-label font-weight-semibold">
                                <?= form_radio(['name'=>'partyType','onclick'=>'load_app_respodent_contempt_petition(2)','checked'=>('2' == $partytype) ? TRUE : FALSE,'value'=>'2','id'=>'res']); ?>Respondent&nbsp;&nbsp;
                            </label>
                            <label for="inp" class="form-check-label font-weight-semibold">
                                <?= form_radio(['name'=>'partyType','onclick'=>'load_app_respodent_contempt_petition(3)','checked'=>('3' == $partytype) ? TRUE : FALSE,'value'=>'3','id'=>'tParty']); ?> Third Party
                            </label>
                        </div>
                    </div>              
                    <div class="row">
                         ...
                         <div class="col-md-12" id="documentUpload" style="display: none">
                        	 <div class="row">		
                                   <div class="col-md-12">
                                        <div class="row">
                                               <div class="col-md-3">
                                                 <label class="control-label" for="fullappeal"><span class="custom"><font color="red">*</font></span>Contempt Petition(Includeing Annexure Per Hard Copy Submitted):</label>
                                               </div>
                                                <div class="col-md-6">
                                          ...
                                          <div class="row">
                                               <div class="col-md-3">
                                                 <label class="control-label" for="ia_files"><span class="custom"><font color="red">*</font></span>Contempt Petition With IA in Word Formate:</label>
                                               </div>
                                                <div class="col-md-6">
                                                     <div class="custom-file" style="border: 1px solid #e5bf88; padding: 5px 8px; border-radius: 6px; background: #eee; margin: auto 0px;">
 ...
 <?php $this->load->view("admin/footer"); ?>	
	...
	function popitup(filingno,ianumbt,year) {
	 ...
	 function filingAction_contempt() {
 	 	...
 	 	if(iaval!='3'){
			...
			dataa['pp']=  pp,
	         ...
	         $.ajax({
	             type: "POST",
	             url: base_url+"/filingaction/contempt_action",
	             data: dataa,
	             cache: false,
	             success: function (resp) {
	            	 document.getElementById("finalview").innerHTML = resp;
	...
	function paymentMode_contempt(values) {
		 var dataa={};
	    dataa['app']=values;
	    dataa['type']='contempt';
	     $.ajax({
	         ...
	         cache: false,
	         success: function (resp) {
	             document.getElementById("payMode_contempt").innerHTML = resp;
	             document.getElementById("payMode_contempt").style.display = 'block'; 
	         },
	         error: function (request, error) {
					$('#loading_modal').fadeOut(200);
	         }
    ...
    function load_app_respodent_contempt_petition(value) {
        var filing_no = $("#filing_no").val();
        var dataa={};
