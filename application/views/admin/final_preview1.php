                ...
                <div class="content clearfix" id="mainDiv1">
                    ...
                    <div class="row">
                            ...
                            <FIELDSET>
                                ...
                                <table id="example" class="display" cellspacing="0" border="1" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td width="16%">Jurisdiction</td>
                                        <td width="16%"><?php echo $sub_name; ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Under sub-section</td>
                                        <td>1&2</td>
                                    </tr>
                                    <tr>
                                        <td>Total No of Respondent(s)</td>
                                        <td><?php echo $resno; ?></td>
                                        <td> <?php  if($this->config->item('ia_privilege')==true):?>Total No. of IAs <?php endif;?></td>
                                        <td><?php echo $iano; ?></td>
                                        <td>Total No. of Annexure(s)</td>
                                        <td><?php echo $petno; ?></td>
                                    </tr>
                                </table>
                                <h5>Commission/Regulators order details</h5>
                                <table id="example" class="display" cellspacing="0" border="1" width="100%">
                                    <tr>
                                ...
                                <?php 
                                    echo form_fieldset('Appellant(s)  Details',['style'=>'margin-top:12px;border: 2px solid #4cb060;']).
                     ...
                     <?php  echo form_fieldset_close(); ?>
                                ...
                                <?php 
                                    echo form_fieldset('Respondent(s) Details',['style'=>'margin-top:12px;border: 2px solid #4cb060;']).
                                    '<i class="icon-plus-circle2 text-danger" style="position: absolute;padding: 21px 6px;"></i>'; ?>
                                ...
                                <div class="offset-md-8 col-md-4">
                                    <?php if($total==0):
                                        ...
                                        echo '<i class="icon-file-plus" style="position: absolute; margin: 9px 4px; z-index: 9; color: white;"></i>'.
                                            form_button(['content' => 'Final Submit','value'=>'false','onclick'=>'javascript:finaldiarysubmit()','class'=>'btn btn-success','id'=>'finalsave','style'=>'padding-left:24px;']).
       ...
       function printPage(){
	    ...
	    function finaldiarysubmit(){
               $.ajax({
                   type: "POST",
                   url: base_url+'efilingfinalsubmit',
                   data:$('form').serialize()+'&sql='+parseInt($("#saltNo").val())+'&typefiled='+$("#org").val()+'&typefiledres='+$("#orgres").val()+
                   '&type='+$("#caseType").val(),
                   cache: false,
                   beforeSend: function(){
                       $('#finalsave').prop('disabled',true).val("Under proccess....");
