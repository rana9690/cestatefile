...
<?php if($bd==3){?>
        ...
        <div class="row ">
          <div class="col-md-4" style="margin-top:25px;margin-left: 1024px;">
   		 	<input type="button" name="btnSubmit" id="btnSubmit" value="Final Submit" class="btn btn-success btn-lg float-left" onclick="finalsubmitEdit()">
        </div>
