                ...
                <div class="content clearfix">
                        ...
                        <div class="row">
                            <div class="offset-md-8 col-md-4">
                                <input  type="button" value="Save and Next" id="chkBtn" class="btn btn-success" onclick="docchecksubmit();" disabled="disabled">
...
<script>
    ...
    function docchecksubmit(){
        var allCheck=$('#allCheck').val();
        if(allCheck=='<?=$count?>'){
            $.ajax({
                type: 'post',
                url: base_url+'chk_listdataDoc',
                data: $('form').serialize(),
                dataType: 'json',
