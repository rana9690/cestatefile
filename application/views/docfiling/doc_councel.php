...
$filing_no='';
if($salt!=''){
    $cavd= $this->efiling_model->data_list_where('temp_docdetail','salt',$salt);
    $did=isset($cavd[0]->docids)?$cavd[0]->docids:'';
    $filing_no=isset($cavd[0]->filing_no)?$cavd[0]->filing_no:'';
    $type=isset($cavd[0]->doctype)?$cavd[0]->doctype:'';
}
$dis="";
if($type=='va'){
    $dis="";
...
?>
            ...
            <div class="row">
                <div class="card checklistSec" style="">
                    <fieldset id="condetail" style="margin-top:20px;">
                        ...
                        <div class="row">
                            <?php 
                    $app= $this->efiling_model->data_list_where('temp_docdetail','salt',$salt);
                    $pet_council_adv=isset($app[0]->council_name)?$app[0]->council_name:''; 
                    ...
                    ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group required" id="div-add">
                                    ...
                                    <input type="text" name="advname" value="" id=advname class="form-control"
                                        onkeypress="serchrecordvaladv(this.value);" <?php echo $dis; ?>>
                            ...
                            <div class="col-md-4">
                                <div class="form-group required">
                                    ...
                                    ?>
                                    <?= form_input(['name'=>'counselPhone','value'=>'','class'=>'form-control','id'=>'counselPhone','placeholder'=>'Counsel Phone','pattern'=>'[0-9]{1,12}','maxlength'=>'10','title'=>'Counsel Phone should be numeric only.']) ?>
                                </div>
                            </div>
                        </div>
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if (resp.data == 'success') {
                    setTimeout(function() {
                        window.location.href = base_url + 'doc_finalprivew';
                    }, 250);
    ...
    function showUserOrg(str) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'getAdvDetailForDocs',
            data: dataa,
            cache: false,
            success: function(petSection) {
                var data1 = petSection;
    ...
    function serchrecordvaladv(val) {
        var data = {};
        data['key'] = val;
        data['saltNo'] = $("#saltNo").val();

        $.ajax({
            type: 'post',
            url: base_url + 'getAdvForDocs',
            data: data,
            dataType: 'html',
            cache: false,
            beforeSend: function() {
