...
<div class="content" style="padding:0px;">
    <div class="row">
        <div class="card checklistSec" style="">
            ...
            <?= form_fieldset('Party Detail ').'<i class="icon-plus-circle2 text-danger d-none" style="position: absolute;padding: 9px 6px;"></i>'; ?>
                ...
                <div class="row">
                                                    ...
                                                    if ($selected_radio1 == 1) {
                                                        ...
                                                        $option_value = '
                                                            <tr> 
                                                                ...
                                                                <td><input type="checkbox" id="additionla_partyy1"  name="additionla_partyy" value="1" '.$checked.'></td>
                                                            </tr>';
                                                    } else {
                                                        $party_tags = 'R';
                                                        if(in_array('1', $partys)){
                            ...
                            <div class="row">
                                <div class="col-md-4" id="org">
                                    <div class="form-group required">
                                        <label><span class="custom">
                                                <font color="red">*</font>
                                            </span>Select Organization :</label>
                                        <select name="select_org_app1" class="form-control" id="select_org_app1"
                                            onchange="apple_org_details_ia1(this.value)">
                                            <option value="">Select Org Name</option>
                                            <?php $hscquerytttt ='';
                                                    foreach ($hscquerytttt as $row) { ?>
                                            <option value="<?php echo htmlspecialchars($row->org_id); ?>">
                                                <?php echo htmlspecialchars($row->orgdisp_name); ?></option>
                                            <?php }  ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4" id="ind" style="display:none">
                                    <div class="form-group required">
                                        ...
                                        <input type="text" name="select_org_app1" id="select_org_app1"
                                            class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group required">
                                        <label><span class="custom">
                                                <font color="red">*</font>
                                            </span>Designation: </label>
                                        <input type="text" name="degingnation1" value="" id="degingnation1"
                                            class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group required">
                                        <label><span class="custom">
                                                <font color="red">*</font>
                                            </span> Address Of Appeliant: </label>
                                        <textarea name="petAddress1" id="petAddress1" class="form-control"
                                            cols="25"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group required">
                                        <label><span class="custom">
                                                <font color="red">*</font>
                                            </span>State Name : </label>
                                        <select name="dstate1" class="form-control" id="dstate1"
                                            ...
                                            <option value="<?php echo htmlspecialchars($row->state_code);?>">
                                                <?php echo htmlspecialchars($row->state_name);?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group required">
                                        ...
                                        <input type="text" name="pincode1" value=" " id="pincode1" class="form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group required">
                                        ...
                                        <input type="text" name="petmobile1" id="petmobile1" class="form-control"
                                            onkeypress="return isNumberKey(event)" maxlength="10" value="" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group required">
                                        ...
                                        <input type="text" name="petPhone1" id="petPhone1" class="form-control"
                                            maxlength="11" value="" onkeypress="return isNumberKey(event)" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group required">
                                        ...
                                        <input type="text" name="petEmail1" id="petEmail1" class="form-control"
                                            value="" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group required">
                                        ...
                                        <input type="text" name="petFax1" id="petFax1" class="form-control" value=""
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group required">
                                            <label><span class="custom">
                                                    <font color="red">*</font>
                                                </span>Counsel Name: </label>
                                            <select name="councilCode" class="form-control" id="councilCode"
                                                onchange="showUserOrg(this.value)">
                                                ...
                                                <option
                                                    <?php echo $selected; ?>value="<?php echo htmlspecialchars($row->adv_code); ?>">
                                                    <?php echo htmlspecialchars($row->adv_name . '(' . $row->adv_reg . ')'); ?>
                                                </option>
                                                <?php }  ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group required">
                                            <label><span class="custom">
                                                    <font color="red">*</font>
                                                </span>Address Of Counsel: </label>
                                            <textarea name="counselAdd" readonly id="counselAdd" class="form-control"
                                                cols="25"><?php echo htmlspecialchars(isset($pet_cou_addm)?$pet_cou_addm:''); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group required">
                                            ...
                                            <input type="text" name="cdstate" class="form-control" readonly id="cdstate"
                                                maxlength="50" value="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group required">
                                            ...
                                            <input type="text" name="ddistrictname" id="ddistrictname"
                                                class="form-control" maxlength="50" value="" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group required">
                                            ...
                                            <input type="text" name="counselPin" readonly value="" id="counselPin"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group required">
                                            ...
                                            <input type="text" name="counselFax" readonly id="counselFax"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group required">
                                            ...
                                            <input type="text" readonly name="counselMobile" id="counselMobile"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group required">
                                            ...
                                            <input type="text" readonly name="counselPhone" id="counselPhone"
                                                class="form-control" maxlength="11" value=""
                                                onkeypress="return isNumberKey(event)" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group required">
                                            ...
                                            <input type="text" readonly name="counselEmail" id="counselEmail"
                                                class="form-control" value="" />
                                        </div>
                                    </div>
                                </div>
                                <div style="float:right">
                                    <input type="button" name="nextsubmit" id="nextsubmit" value="Add More Counsel"
                                        class="btn1" onclick="addMoreCouncel();">
                                </div>
                            </div>
                            <?php  } ?>
                    </div>
                    ...
                    <div class="row" style="margin-top:20px">
                        <div class="col-md-4">
                            <div class="form-group required" id="vaids">
                                <label><span class="custom">
                                        <font color="red">*</font>
                                    </span>Docuemnt Type : </label>
                                <select id="doc_dtype" class="form-control" name="doc_dtype"
                                    onClick="openmatter(this.value);">
                            ...
                            <div class="form-group required" id="notvaids" style="display:none">
                                ...
                                <select id="doc_dtype11" class="form-control" name="doc_dtype11"
                                    onClick="openmatter111(this.value);">
                                    <option value="">Select Document Type</option>
                                    <?php foreach($doc as $row){
                        ...
                        <div class="col-md-4" id="matterval" style="display: none;">
                            <div class="col-auto">
                                <label class="visually-hidden" for="inputPassword">
                                    <font color="red">*</font><?=$this->lang->line('matterRemarks')?>
                                </label>
                                <textarea rows="1" cols="25" name="mattertext" id="mattertext"
                    ...
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <input type="button" value="Save and Next" class="btn btn-success" id="ia_save"
                                onclick="docpartysave();" <?php echo $disabled; ?>>
