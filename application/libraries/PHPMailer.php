...
//namespace Libraries;
//use Libraries\SMTP;
//use Libraries\PhpmailerException;
/*~ class.phpmailer.php
.---------------------------------------------------------------------------.
...
class PHPMailer {
 ...
 /**
  ...
  public function __construct($exceptions = false) {
	  $this->IsHTML(true);
	  $this->IsSMTP();
	  /*$this->SMTPDebug = getenv('phpmailer.SMTPDebug');
      $this->Host = getenv('phpmailer.Host');
      $this->Port = getenv('phpmailer.Port');
      $this->SMTPAuth = getenv('phpmailer.SMTPAuth');
      $this->SMTPSecure = getenv('phpmailer.SMTPSecure');
      $this->CharSet = getenv('phpmailer.CharSet');
      $this->Username = getenv('phpmailer.Username');
      $this->Password = getenv('phpmailer.Password');
       $this->AddReplyTo(getenv('phpmailer.SetFrom'), getenv('phpmailer.SetFromName'));
      $this->SetFrom(getenv('phpmailer.SetFrom'), getenv('phpmailer.SetFromName'));
	  */
	  
	  $this->SMTPDebug =0;
      $this->Host = 'relay.nic.in';
      $this->Port = 25;
      $this->SMTPAuth = true;
      $this->SMTPSecure = 'tls';
      $this->CharSet = 'UTF-8';
